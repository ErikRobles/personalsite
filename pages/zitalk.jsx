...
const Zitalk = () => {
  return (
    <>
      <Head>
        <title>ER Portfolio | Online Spanish Lessons Website Project</title>
        <meta
          name='description'
          content='Website for those wanting to learn Spanish Online built with Laravel, PHP, Javascript and Bootstrap.'
        />
      ...
      <div className='w-full overflow-hidden'>
        <div className='w-screen h-[50vh] relative'>
          ...
          <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-3'>
            <h2 className='py-2'>Zitalk Spanish Learning Website</h2>
            <h3>PHP / Laravel / JavaScript / MySQL</h3>
          </div>
        </div>
        ...
        <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8 px-3'>
          <div className='col-span-4'>
            ...
            <p>
              ...
              Since the site was built using Laravel and PHP, it has the
              potential to be much more than a simple corporate website.
            </p>
