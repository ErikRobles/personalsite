...
const Erik = () => {
  return (
    <>
      <Head>
        <title>ER Portfolio | Erik Robles Portfolio Project</title>
        <meta
          name='description'
          content='Erik Robles Portfolio Section made with Next.js, React, Tailwind with a Firebase backend.'
        />
      ...
      <div className='w-full overflow-hidden'>
        ...
        <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8 px-3'>
          <div className='col-span-4'>
            ...
            <h2>Overview</h2>
            <p>
              This is a short description of the site you are looking at. It is
              an example of what can be done with Next.js and React. It uses
              Tailwind CSS and can be modified to suit any clients stylistic
              needs. For the backend I decided to use Google&apos;s FireBase as
              the backend. This will be an ongoing project where I will be
              adding new and more exciting features as time goes on. The design
              of this site is based on the work of Clint Briley who can be found
              on his{' '}
              <a
